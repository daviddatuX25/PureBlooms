    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="px-8 pb-8">
                    <div class="relative flex flex-col sm:flex-row sm:justify-between sm:items-end -mt-12 mb-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <a href="{{ route('customer.profile.edit') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-medium transition text-center">
                                ✏️ Edit Profile
                            </a>
                            <a href="{{ route('customer.profile.password.edit') }}" class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-medium transition text-center">
                                🔐 Change Password
                            </a>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-white rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100">
                    <p class="text-xs md:text-sm text-gray-600 mb-2">📦 Total Orders</p>
                    <p class="text-xl md:text-3xl font-bold text-gray-900">{{ $totalOrders }}</p>
                </div>
                <div class="bg-white rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100">
                    <p class="text-xs md:text-sm text-gray-600 mb-2">💰 Total Spent</p>
                    <p class="text-xl md:text-3xl font-bold text-emerald-600">₱{{ number_format($totalSpent, 2) }}</p>
                </div>
                <div class="bg-white rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100">
                    <p class="text-xs md:text-sm text-gray-600 mb-2">⏳ Pending</p>
                    <p class="text-xl md:text-3xl font-bold text-amber-600">{{ $pendingOrders }}</p>
                </div>
                <div class="bg-white rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100">
                    <p class="text-xs md:text-sm text-gray-600 mb-2">✅ Completed</p>
                    <p class="text-xl md:text-3xl font-bold text-emerald-600">{{ $completedOrders }}</p>
                </div>
            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="border border-gray-200 rounded-xl p-4 hover:shadow-lg transition">
                                ...
                                <div class="mt-3 flex gap-2">
                                    ...
                                    <button onclick="window.print()" class="text-purple-600 hover:text-purple-700 font-medium text-sm">
                                        🖨️ Print
                                    </button>
                                </div>
                            </div>
