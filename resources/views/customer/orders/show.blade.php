<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <button onclick="window.print()" class="flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-black font-bold rounded-xl hover:shadow-lg transition">
            ...
            <div class="card-glass">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        <button onclick="window.print()" class="flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-black font-bold rounded-xl hover:shadow-lg transition">
