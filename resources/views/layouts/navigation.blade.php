                ...
                <div class="relative" x-data="{ dropdownOpen: false }">
                    ...
                    >
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" onclick="return confirm('Are you sure you want to log out?')" class="block w-full text-left px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition flex items-center gap-2">
                                <span>🚪</span>
                                <span>Log Out</span>
                            </button>
                        </form>
