...
// Auth Routes (always accessible - no maintenance middleware)
...
Route::get('/', [HomeController::class, 'index'])->middleware('maintenance')->name('home');
...
})->middleware(['auth', 'verified', 'maintenance'])->name('dashboard');

// Public QR Code Page
Route::get('/qrcode', [QrCodeController::class, 'index'])->middleware('maintenance')->name('qrcode.index');

// ==================== CUSTOMER ROUTES ====================
Route::middleware(['auth', 'App\Http\Middleware\PreventBackHistory::class', 'maintenance'])->prefix('customer')->name('customer.')->group(function () {
    ...
    Route::put('/profile/password', [CustomerProfileController::class, 'updatePassword'])->name('profile.password.update')->middleware('throttle:3,60');
...
// ==================== ADMIN ROUTES ====================
Route::middleware(['auth', 'admin', 'App\Http\Middleware\PreventBackHistory::class'])->prefix('admin')->name('admin.')->group(function () {
